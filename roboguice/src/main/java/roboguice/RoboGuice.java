 ...
 * 1. The base application injector, which is not typically used directly by the
 * user. 2. The ContextScopedInjector, which is obtained by calling
 * {@link #getInjector(android.content.Context)}, and knows about your current
 * context, whether it's an activity, service, or something else.
...
public final class RoboGuice {
    ...
    /**
     * Return the cached Injector instance for this application, or create a new
     * one if necessary. If specifying your own modules, you must include a
     * DefaultRoboModule for most things to work properly. Do something like the
     * following:
     ...
     *      If using this method with test cases, be sure to call
     *      {@link roboguice.RoboGuice.Util#reset()} in your test teardown
     *      methods to avoid polluting our other tests with your custom
     *      injector. Don't do this in your real application though.
     */
            ...
            try {
                ...
                for (String name : moduleNames) {
                    if (Strings.notEmpty(name)) {
                        ...
                        if (isDefaultRoboModule && hasDefaultRoboModule) {
                            throw new RuntimeException("You can define at most one DefaultRoboModule (or none, and in this case DefaultRoboModule is used).");
                        }
                        ...
                        Ln.i("Module %s loaded. DefaultRoboModule : ", clazz.getName(), isDefaultRoboModule);
                        if (module != null) {
                            if (isDefaultRoboModule) {
                ...
                if (!hasDefaultRoboModule) {
                    Ln.i("DefaultRoboModule loaded.");
                    modules.add(0, newDefaultRoboModule(application));
                }

            } catch (NameNotFoundException e) {
                throw new RuntimeException("Enable to read name of application or meta-data from AndroidManifest.xml", e);
    ...
    /**
     * A shortcut for
     * RoboGuice.getInjector(context).injectMembersWithoutViews(o);
     */
    ...
    public static DefaultRoboModule newDefaultRoboModule(Class<? extends DefaultRoboModule> clazz, final Application application) throws IllegalArgumentException, InstantiationException, IllegalAccessException, InvocationTargetException, SecurityException,
            NoSuchMethodException {
        Constructor<? extends DefaultRoboModule> constructor = clazz.getDeclaredConstructor(Application.class, ContextScope.class, ViewListener.class,
    ...
    public static final class Util {
        ...
        /**
         * This method is provided to reset RoboGuice in testcases. It should
         * not be called in a real application.
         */
