...
/**
 * An activity that can be used to display a splash page while
...
public abstract class GuiceSplashActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                final GuiceApplication app = (GuiceApplication)getApplication();
     ...
     * @param app
     */
    protected void doStuffInBackground(GuiceApplication app) {
    }

    /**
     * It's expected that most splash pages will want to finish
     * after they start the next activity, but in case this isn't
     * true you can override this method to change the behavior.
     */
